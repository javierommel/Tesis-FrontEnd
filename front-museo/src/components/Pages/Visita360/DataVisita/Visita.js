...
const information = [
    [
        {
            hotSpot: 1,
            nombres: ["Manualidad Monja tejiendo",
                "Telar y planchas",
        ...
        {
            hotSpot: 2,
            nombres: [`Estandarte "El Obrerismo"`,
                `Estandarte "El Obrerismo"`,
            ],
            imagenes: [
        ...
        },
        {
            ...
            videos: [],
            titulo: "Obra temporal",
            texto: [`En ciertas épocas del año el museo presenta talleres de pintura, bordado, etc. 
            Al terminar estos talleres las obras realizadas y terminadas se exponen en las diferentes salas del museo.`,
            ]
        }
    ],
    [
        ...
        {
            hotSpot: 2,
            nombres: ["Vestidos del niño Jesús",
        ...
        },
        {
            ...
            videos: [],
            titulo: "Lavadora Manual",
            texto: [`- Sobre una especie de banquillo de madera  de cuatro patas se encuentra el envase circular de madera dentro del que se encuentra el mecanismo metálico que  hace girar la lavadora.
            - Tiene tapa metálica.
            - En la parte posterior superior está el mecanismo para exprimir la ropa a base de rodillos y accionado por una manivela`,
            ]
        },
        {
            hotSpot: 4,
            nombres: ["Capas del niño Jesús",
                "Capas del niño Jesús",
            ],
            imagenes: [
...
export { piecesArray, information };